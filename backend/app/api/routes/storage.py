...
async def upload_image(file: UploadFile, user: CurrentUser = Depends(get_current_user)):
    ...
    against their own domain rows (e.g. scan_session.image_url or
    product.image_url) and re-sign a fresh URL at read time rather than
    storing a long-lived public URL.
    """
